...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_LIGHT_GREY = SET_BG_COLOR + "262m";
    public static final String SET_BG_COLOR_DARK_GREY = SET_BG_COLOR + "245m";
    public static final String SET_BG_COLOR_RED = SET_BG_COLOR + "160m";
    public static final String SET_BG_COLOR_GREEN = SET_BG_COLOR + "66m";
